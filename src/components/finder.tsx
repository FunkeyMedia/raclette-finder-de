...
const guidedSteps: Step[] = [
  ...
  { key: "budget", eyebrow: "Dein Rahmen", question: "Welche Budgetklasse fühlt sich richtig an?", help: "Wir zeigen keine angeblichen Livepreise. Die Klasse bezieht sich auf den zuletzt geprüften Produktpreis.", options: [{ value: "low", title: "Bis etwa 55 €", description: "Preisbewusst" }, { value: "mid", title: "Etwa 35–105 €", description: "Solide Mitte" }, { value: "premium", title: "Ab etwa 85 €", description: "Premium & Spezial" }], unsure: "any" },
