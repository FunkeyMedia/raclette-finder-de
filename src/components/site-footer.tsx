  ...
  return (
    <footer className="site-footer">
      <div className="site-width footer-grid">
        ...
        <div><h2>Rechtliches</h2><Link href="/impressum">Impressum</Link><Link href="/datenschutz">Datenschutz</Link><p className="affiliate-mini">Als Amazon-Partner verdienen wir an qualifizierten Verkäufen.</p><p className="ai-image-note"><span>KI</span> Einige redaktionelle Bilder wurden mithilfe von KI erstellt.</p></div>
      </div>
