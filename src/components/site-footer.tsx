  ...
  return (
    <footer className="site-footer">
      <div className="site-width footer-grid">
        ...
        <div><h2>Entdecken</h2><Link href="/finder">Produktfinder</Link><Link href="/vergleich">Vergleich</Link><Link href="/ratgeber">Kaufberatung</Link><Link href="/produkte">Alle Geräte</Link></div>
